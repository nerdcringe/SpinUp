...
// double getGlobalX();
// double getGlobalY();
// void resetOdomPosition(); // reset back to 0, 0
...
// */
// void setTarget(double x, double y); // set the target point in x,y
// void setTargetPolar(double dist, double degrees); // set the target relative distance and angle
// void turnToTarget(double maxTurnSpeed); // turn towards the target point
// void moveToTarget(double maxFwdSpeed, double maxTurnSpeed, int timeoutMillis=-1);
// void moveToTargetRev(double maxFwdSpeed, double maxTurnSpeed, int timeoutMillis=-1);
// void passTarget(double maxFwdSpeed, double maxTurnSpeed, int timeoutMillis=-1);
// void passTargetRev(double maxFwdSpeed, double maxTurnSpeed, int timeoutMillis=-1);
