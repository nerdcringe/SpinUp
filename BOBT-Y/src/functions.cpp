...
void forwardPID(double targetInches, double maxSpeed, int msTimeout) {
  ...
  double derTheshold = 0.001; // Only exit loop when derivative is less than this
  double minSpeed = 2; // stay at least this fast to overcome friction. May be more reliable than using integral
