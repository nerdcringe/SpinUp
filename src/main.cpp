...
// ODOMETRY /////////////////////////////////////////////////////////////////////////////
  ...
  void moveTo(double x, double y, double maxFwdSpeed, double maxTurnSpeed)
  {
    ...
    while (curFwdSpeed != 0)
    {
      ...
      if (followPosition)
      {
        ...
        lastMotorPos = getMotorPos(); // use as the initial position of final forward
      }
      else // when close to target, just move forward the last little distance and don't turn
      {
        curFwdSpeed = odomFwdPID(lastMotorPos + targetDistance - getMotorPos(), maxFwdSpeed);
        curTurnSpeed = 0;
      }
  ...
  void moveToWaypoint(double x, double y, double maxFwdSpeed, double maxTurnSpeed)
  {
    ...
    bool passedY = false;
      ...
      // run while x and y have not crossed the point yet
...
int main()
{
  ...
  /*moveToWaypoint(10, 10, 30, 30);
  moveTo(20, 20, 30, 30);*/
  // final angles: 40.3, 39.3, 39.3, 37.4, 39.1 ,38.8
